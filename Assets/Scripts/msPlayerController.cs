...
public class msPlayerController : MonoBehaviour
{
    ...
    private void PlayerMove()
    {
        ...
        //upperBody.transform.LookAt(MousePosition);

        /*if (aimMode == true)//테스트 중인 부분. 지워도 무관.
        {
            upperBody.LookAt(aimDirection);
            upperBody.rotation = upperBody.rotation * Quaternion.Euler(relativeVec);
